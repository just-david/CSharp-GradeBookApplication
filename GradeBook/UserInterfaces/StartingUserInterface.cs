...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            var weighting = bool.Parse(parts[3]);
            switch (parts[2])
            {
                case "standard": gradeBook = new StandardGradeBook(name, weighting); break;
                case "ranked": gradeBook = new RankedGradeBook(name, weighting); break;
                default:
